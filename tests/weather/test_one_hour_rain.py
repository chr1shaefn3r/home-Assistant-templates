"""Rain group — one-hour rain scenario."""
from datetime import datetime

TEMPLATE = "weather/daily_rain_summary.jinja"

FORECAST_ONE_HOUR_RAIN = [
    ...
    {"condition": "cloudy",       "datetime": "2026-03-27T11:00:00+00:00", "wind_bearing": 328.1, "cloud_coverage": 96.1, "uv_index": 3.2, "temperature":  6.1, "wind_speed": 6.1, "precipitation": 0.0, "humidity": 61},
    ...
    {"condition": "cloudy",       "datetime": "2026-03-27T14:00:00+00:00", "wind_bearing": 306.8, "cloud_coverage":100.0, "uv_index": 1.9, "temperature":  7.6, "wind_speed": 6.8, "precipitation": 0.0, "humidity": 52},
    {"condition": "partlycloudy", "datetime": "2026-03-27T15:00:00+00:00", "wind_bearing": 302.5, "cloud_coverage": 82.8, "uv_index": 1.0, "temperature":  7.5, "wind_speed": 7.6, "precipitation": 0.0, "humidity": 52},
...
def test_one_hour_rain_message(render):
    result = render(TEMPLATE, now=datetime(2026, 3, 27, 5, 0, 0), variables={"forecast": FORECAST_ONE_HOUR_RAIN})
    assert "Heute regnet es von 10 bis 11 Uhr" in result
